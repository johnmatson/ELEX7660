...
module lab5_mm_interconnect_0 (
		...
		input  wire [17:0] processor_data_master_address,               //                 processor_data_master.address
		...
		input  wire [17:0] processor_instruction_master_address,        //          processor_instruction_master.address
	...
	wire  [17:0] processor_data_master_translator_avalon_universal_master_0_address;              // processor_data_master_translator:uav_address -> processor_data_master_agent:av_address
	...
	wire  [93:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> processor_data_master_agent:rp_data
	...
	wire  [17:0] processor_instruction_master_translator_avalon_universal_master_0_address;       // processor_instruction_master_translator:uav_address -> processor_instruction_master_agent:av_address
	...
	wire  [93:0] rsp_mux_001_src_data;                                                            // rsp_mux_001:src_data -> processor_instruction_master_agent:rp_data
	...
	wire  [17:0] processor_debug_mem_slave_agent_m0_address;                                      // processor_debug_mem_slave_agent:m0_address -> processor_debug_mem_slave_translator:uav_address
	...
	wire  [94:0] processor_debug_mem_slave_agent_rf_source_data;                                  // processor_debug_mem_slave_agent:rf_source_data -> processor_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [94:0] processor_debug_mem_slave_agent_rsp_fifo_out_data;                               // processor_debug_mem_slave_agent_rsp_fifo:out_data -> processor_debug_mem_slave_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> processor_debug_mem_slave_agent:cp_data
	...
	wire  [94:0] pio_s1_agent_rf_source_data;                                                     // pio_s1_agent:rf_source_data -> pio_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] pio_s1_agent_rsp_fifo_out_data;                                                  // pio_s1_agent_rsp_fifo:out_data -> pio_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> pio_s1_agent:cp_data
	...
	wire  [94:0] spi_0_spi_control_port_agent_rf_source_data;                                     // spi_0_spi_control_port_agent:rf_source_data -> spi_0_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [94:0] spi_0_spi_control_port_agent_rsp_fifo_out_data;                                  // spi_0_spi_control_port_agent_rsp_fifo:out_data -> spi_0_spi_control_port_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_005_src_data;                                                            // cmd_mux_005:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire  [93:0] processor_data_master_agent_cp_data;                                             // processor_data_master_agent:cp_data -> router:sink_data
	...
	wire  [93:0] processor_instruction_master_agent_cp_data;                                      // processor_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [93:0] processor_debug_mem_slave_agent_rp_data;                                         // processor_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [93:0] pio_s1_agent_rp_data;                                                            // pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [93:0] spi_0_spi_control_port_agent_rp_data;                                            // spi_0_spi_control_port_agent:rp_data -> router_007:sink_data
	...
	lab5_mm_interconnect_0_router router (
	...
	lab5_mm_interconnect_0_router_001 router_001 (
	...
	lab5_mm_interconnect_0_router_002 router_002 (
	...
	lab5_mm_interconnect_0_router_003 router_003 (
	...
	lab5_mm_interconnect_0_router_003 router_004 (
	...
	lab5_mm_interconnect_0_router_002 router_005 (
	...
	lab5_mm_interconnect_0_router_002 router_006 (
	...
	lab5_mm_interconnect_0_router_002 router_007 (
	...
	lab5_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clock_clk_clk),                               //       clk.clk
		.reset              (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clock_clk_clk),                               //       clk.clk
		.reset               (processor_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab5_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
